            ...
            <nav className="relative z-10 flex items-center justify-between px-2 lg:px-16 py-2 border-b border-inputaccent/50 w-full">
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <NavLink to="/login" className="cursor-pointer">
                        {profile ? <img src={profile.avatar_url} alt="profile" className="h-8 w-8 rounded-full" /> : <div className="bg-accent-dark rounded-full px-2 py-1 cursor-pointer text-white">Login</div>}
                    </NavLink>
                </div>
