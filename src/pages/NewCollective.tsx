                ...
                <form className="w-full space-y-6" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input
                            type="text"
                            id="collectiveName"
                            placeholder="e.g. Eastside Social Club"
                    ...
                    <div>
                        ...
                        <textarea
                            id="description"
                            rows={5}
                            placeholder="Tell people what your collective is about, the kind of events you host, and who it welcomes…"
                    ...
                    <div>
                        ...
                        <textarea
                            id="guidelines"
                            rows={5}
                            placeholder="Set the expectations for members and organisers. For example: be respectful, share updates, keep events inclusive, support venue etiquette…"
                            className="w-full bg-inputbg/30 border border-inputaccent rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent resize-y"
