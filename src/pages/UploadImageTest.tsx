            ...
            <main className="flex flex-col items-center lg:items-start px-4 py-8 lg:px-8 lg:py-12 lg:max-w-4xl lg:mx-auto w-full">
                ...
                : error
                    ...
                    : 'border-inputaccent/50 hover:border-accent'}`}>
                            <input ref={fileInputRef} type="file" accept="image/jpeg,image/png,image/webp,image/gif" onChange={handleInputChange} className="hidden"/>
                    ...
                    {/* Result */}
                    {uploadedUrl && (<div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    {error && !preview && (<div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-red-700">
                            {error}
                        </div>)}
                </div>
            </main>
