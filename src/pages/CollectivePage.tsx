        ...
        <div className="container mx-auto px-4 py-8 lg:px-8 lg:py-12">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 pb-6 border-b border-inputaccent/20">
                ...
                <div className="flex gap-2 shrink-0">
                    ...
                    {isOwner ? (<button className="px-4 py-2 rounded-lg border border-inputaccent/30 text-sm text-gray-700 hover:bg-accent hover:text-white hover:border-accent transition-colors cursor-pointer" onClick={ () => {
                            toast.loading("Loading Manage collective...", { duration: 500 });
                            navigate(`/manage-collective/${collective.id}`)
                        }
                    }>
                        Manage Collective
